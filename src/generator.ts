...
// All font file names — must match actual .flf filenames in the fonts/ directory
const ALL_FONT_FILES = [
	"1Row", "3-D", "3D Diagonal", "3D-ASCII", "3x5", "4Max",
	"5 Line Oblique", "Acrobatic", "Alligator", "Alligator2", "Alpha", "Alphabet",
	...
	"ASCII 12", "ASCII 9", "ASCII New Roman", "Avatar",
	...
	"Big Money-se", "Big Money-sw", "Big Mono 12", "Big Mono 9",
	"Bigfig", "Binary", "Block", "Blocks", "Bloody", "BlurVision ASCII",
	"Bolger", "Braced", "Bright", "Broadway", "Broadway KB", "Bubble", "Bulbhead",
	"Caligraphy", "Caligraphy2", "Calvin S", "Cards", "Catwalk",
	"Chiseled", "Chunky", "Circle", "Classy", "Coder Mini", "Coinstak", "Cola",
	"Colossal", "Computer", "Contessa", "Contrast", "Cosmike", "Cosmike2",
	"Crawford", "Crawford2", "Crazy", "Cricket", "Cursive",
	"Cyberlarge", "Cybermedium", "Cybersmall", "Cygnet",
	"DANC4", "Dancing Font", "Decimal", "Def Leppard",
	"Delta Corps Priest 1", "DiamFont", "Diamond", "Diet Cola",
	"Digital", "Doh", "Doom", "DOS Rebel",
	"Dot Matrix", "Double", "Double Shorts", "Dr Pepper", "DWhistled",
	...
	"Flipped", "Flower Power", "Font Font",
	...
	"Katakana", "Kban", "Keyboard", "Knob", "Konto", "Konto Slant",
	"Larry 3D", "Larry 3D 2", "LCD", "Lean", "Letter", "Letters",
	"Lil Devil", "Line Blocks", "Linux", "Lockergnome",
	"Madrid", "Marquee", "Maxfour",
	"Merlin1", "Merlin2", "Mike", "Mini", "miniwi", "Mirror", "Mnemonic", "Modular",
	"Mono 12", "Mono 9", "Morse", "Morse2", "Moscow", "Mshebrew210", "Muzzle",
	"Nancyj", "Nancyj-Fancy", "Nancyj-Improved", "Nancyj-Underlined", "Nipples",
	"NScript", "NT Greek", "NV Script",
	"O8", "Octal", "Ogre", "Old Banner", "OS2",
	"Pagga", "Patorjk-HeX", "Patorjk's Cheese", "Pawp", "Peaks", "Peaks Slant",
	"Pebbles", "Pepper", "Poison", "Puffy", "Puzzle", "Pyramid",
	"Rammstein", "Rebel", "Rectangles", "Red Phoenix",
	"Relief", "Relief2", "Reverse",
	"Roman", "Rot13", "Rotated", "Rounded", "Rowan Cap", "Rozzo", "RubiFont",
	"Runic", "Runyc",
	"S Blood", "Santa Clara", "Script", "Serifcap", "Shaded Blocky", "Shadow", "Shimrod", "Short",
	"SL Script", "Slant", "Slant Relief", "Slide",
	...
	"Stop", "Straight", "Stronger Than All",
	"Sub-Zero", "Swamp Land", "Swan", "Sweet",
	"Tanja", "Tengwar", "Term", "Terrace", "Test1",
	"The Edge", "Thick", "Thin", "THIS", "Thorned", "Three Point",
	"Ticks", "Ticks Slant", "Tiles", "Tinker-Toy", "Tmplr",
	"Tombstone", "Train", "Trek", "Tsalagi", "Tubular",
	"Twisted", "Two Point",
	"Univers", "Upside Down Text", "USA Flag", "Varsity",
	"Wavescape", "Wavy", "Weird", "Wet Letter", "Whimsy", "WideTerm", "Wow",
];
